...
<header>
    <div class="header">
      ...
      <a href="/" class="icon">
        <div class="logo">
          <img src="./assets-images/Builder.PNG" alt="Логотип">
        </div>
        <h1>Hardware Shop</h1>
      </a>
      <div class="search-bar">
        <input type="text" placeholder="Пошук обладнання">
...
<footer>
    <p>Hardware Shop</p>
     <p>Увесь контент веб-сайту, а  також будь-який контент, поширення якого здійснюється за допомогою цього сайту (зокрема, зображення та тексти) захищені авторським правом.</p>
`
    ...
    cart.addEventListener("click", () => {
        ...
        if (cartList.length === 0) {
            ...
            <div class="empty-cart-container">
                <img src="./assets-images/empty.png" class="empty" alt="Порожній кошик">
        ...
        cartList.forEach((e, index) => {
            ...
            close.addEventListener("click", e => {
                ...
                if (cartList.length === 0) {
                    ...
                    const emptyCart = `
                    <div class="empty-cart-container">
                        <img src="./assets-images/empty.png" class="empty-cart-image" alt="Порожня корзина">
        ...
        <div class="sort-by">
          <div class="sort-container">
            <div class="by-price">
              ...
              <span>Від <input class="number-input" id="by-price-min" value="0" type="text"></span> 
              <span>До <input class="number-input" id="by-price-max" type="text">$</span></span>
            </div>
            <div class="by-rate">
              <h3>Рейтинг</h3>
              <span class="main-span">
              <span>Від <input class="number-input" id="by-rate-min" value="0" type="text"></span>
               <span>До <input class="number-input" id="by-rate-max" type="text"></span>
            </div>
          </div>
